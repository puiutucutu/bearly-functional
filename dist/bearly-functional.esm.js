...
var parseDateToStyle = function parseDateToStyle(style) {
  return function (date) {
    return isValidDateISO(date) ? format(parseISO(date), style) : "";
  };
};
...
var getISO8601DateWithTimeOffsetFromUTC = function getISO8601DateWithTimeOffsetFromUTC() {
  ...
  return microseconds ? format(new Date(), "yyyy-MM-dd'T'HH:mm:ss.SSSSSSSxxx") : format(new Date(), "yyyy-MM-dd'T'HH:mm:ssxxx");
};
...
var makeDate = function makeDate(style) {
  return function (date) {
    return isValid(parseISO(date)) ? format(parseISO(date), style) : "";
  };
};
...
var isArray$1 = function isArray(xs) {
